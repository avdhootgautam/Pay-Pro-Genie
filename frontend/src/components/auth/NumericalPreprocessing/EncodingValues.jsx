// Here i will design the component for Encoding the dataset
import { Box , Typography,Button} from "@mui/material"
const EncodingValues=({numericalPreproStep,setStrategy,strategy,columnPrepro,setColumnPrePro,finalOperation,setApplyAndSaveButton})=>{
    ...
    return (
        <Box  sx={{color:"whitesmoke",paddingTop:"2px",paddingLeft:"10px",display:"flex",flexDirection:"column"}}>
           <Box sx={{display:"flex",flexDirection:"column"}}>
                <Box sx={{height:"40px"}}><h3>{numericalPreproStep} Categorical Columns</h3></Box>
                <Box sx={{paddingBottom:"5px"}}><Typography sx={{fontSize:"14px",fontWeight:300,color:'gray'}}>Choose One-Hot or Label encoding and the target columns.</Typography></Box>
            </Box>
            <Box sx={{display:"flex",flexDirection:"row",paddingTop:"5px"}}>
                <Box sx={{display:"flex",flexDirection:"column"}}>
                    <Typography sx={{fontSize:"14px",fontWeight:300,color:'gray'}}>TYPE</Typography>
                    <Box sx={{paddingTop:"5px"}}>
                        <Button sx={strategyBtnStyle(strategy==="One Hot")} onClick={()=>{handleStrategyButton("One Hot")}}>One Hot</Button>
                        <Button sx={strategyBtnStyle(strategy==="Label")} onClick={()=>{handleStrategyButton("Label")}}>Label</Button>
                    </Box>
                </Box>
